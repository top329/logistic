...
export default function ImportFunc() {
  ...
  const toast = () => {
    return (
      <div className='w-[509px] bg=[#49454F] text-[#F4EFF4]'>
        This is the shipping address, it is the location the package will be delivered to. the customer can then request for doorstep delivery upon arrival.
      </div>
    );
  }
  ...
  function ConfirmImportOrderInfoChild() {
    return (
  ...
  function ConfirmImportPackageDetailChild() {
    return (
  ...
  function ConfirmImportItemChild() {
    return (
      <div className='px-[18px] py-2'>
        <div className=' grid grid-cols-5 gap-4'>
  ...
  function ConfirmImportBillingDetailChild() {
    return (
      <div className='flex flex-col gap-y-4 px-[18px] py-2'>
        <div className='grid grid-cols-5 gap-4'>
          <div className='col-span-2'>
  ...
  function ConfirmImportPaymentInfoChild() {
    return (
            ...
            <div className='flex flex-col gap-y-[10px] !rounded-[20px] !px-[14px] !py-[10px] !bg-[#F2B8B5]'>
              ...
              <div className='flex !px-[14px] !pb-[10px]'>
                <ul className='list-disc !px-[14px] list-inside'>
                  <li>The  package will be delivered to the <span className='!font-bold'> ”Destination/Shipping Address” (which is our available office in Nigeria) </span> you will select.</li>
                    ...
                    items={[
                      {
                        key: '1', label: (
                          <div
                            className='!flex justify-between items-center shadow-sm rounded-[20px] !py-[10px] gap-y-[30px]'
                          >
                            <Radio value={2} className='!flex w-full'>
                              <div className='flex justify-between pr-[6px] '>
                                <p className='!pl-[20px] text-[22px]'>
  ...
  const ConfirmDetailImport = () => {
    const [isOrder, setIsOrder] = useState(true)
    const [isModalOpen, setIsModalOpen] = useState(false);
    const orderId = "Obee921"
          ...
          >
            ...
            <div className='w-full'>
              ...
              <div className='flex items-center gap-2 mb-2.5'>
                <Collapse
                  defaultActiveKey={['1']}
                  items={[{ key: '1', label: (<p className='text-[22px] px-4 text-[#49454F]'>Order Information</p>), children: <ConfirmImportOrderInfoChild /> }]}
            ...
            <div className='flex items-center gap-2 mb-2.5'>
              <Collapse
                defaultActiveKey={['1']}
                items={[{ key: '1', label: (<p className='text-[22px] px-4 text-[#49454F]'>Package Origin/ Shipment location</p>), children: <ConfirmImportPackageDetailChild /> }]}
                expandIcon={({ isActive }) => isActive ? <IconExpand /> : <IconExpand />}
                expandIconPosition='end'
                className='w-full !bg-white !rounded-xl'
              />
            ...
            <div className='flex items-center gap-2 mb-2.5'>
              <Collapse
                defaultActiveKey={['1']}
                items={[{ key: '1', label: (<p className='text-[22px] px-4 text-[#49454F]'>Item #1</p>), children: <ConfirmImportItemChild /> }]}
                expandIcon={({ isActive }) => isActive ? <IconExpand /> : <IconExpand />}
                expandIconPosition='end'
                className='w-full !bg-white !rounded-xl'
              />
            ...
            <div className='flex items-center gap-2 mb-2.5'>
              <Collapse
                defaultActiveKey={['1']}
                items={[{ key: '1', label: (<p className='text-[22px] px-4 text-[#49454F]'>Destination/ Shipping Address</p>), children: <ConfirmImportPackageDetailChild /> }]}
                expandIcon={({ isActive }) => isActive ? <IconExpand /> : <IconExpand />}
                expandIconPosition='end'
                className='w-full !bg-white !rounded-xl'
              />
            ...
            <div className='flex items-center gap-2 mb-2.5'>
              <Collapse
                defaultActiveKey={['1']}
                items={[{ key: '1', label: (<p className='text-[22px] text-[#49454F]'>Billing Information</p>), children: <ConfirmImportBillingDetailChild /> }]}
                expandIcon={({ isActive }) => isActive ? <IconExpand /> : <IconExpand />}
                expandIconPosition='end'
                className='w-full !bg-white !rounded-xl'
              />
            ...
            <div className='flex items-center gap-2 mb-2.5'>
              <Collapse
                defaultActiveKey={['1']}
                items={[{ key: '1', label: (<p className='text-[22px] text-[#49454F]'>Payment Information</p>), children: <ConfirmImportPaymentInfoChild /> }]}
                expandIcon={({ isActive }) => isActive ? <IconExpand /> : <IconExpand />}
                expandIconPosition='end'
                className='w-full !bg-white !rounded-xl'
              />
  ...
  const renderChildComponent = () => {
    switch (currentChildId) {
      case 1:
        return <OrderCreate />;
      case 2:
        return <Package_Details_import />;
      case 3:
        return <Shipping_Detail />;
      case 4:
        return <Billing_Details />;
      case 5:
        return <ConfirmDetailImport />;
      default:
        return null;
    }
  };
