...
export default function OrderDraftDetail({ orderId }: { orderId: any }) {
      ...
      <div className="flex justify-between h-[121px] bg-white rounded-b-2xl border-b-2 px-10 py-6 items-center">
        <div>
          ...
          <div className="flex items-center gap-4">
            ...
            <IconArrowLeft />
            <p className="text-[#625B71] text-base font-semibold">order id: {orderId}</p>
          </div>
        </div>
      ...
      <div className='p-6 h-[calc(100vh-7.6rem)] overflow-y-scroll'>
        ...
        >
                  ...
                  key: '1', label: (<p className='text-[22px] px-4 text-[#49454F]'>Shipment Details</p>), children:
                    <div className='px-[18px] py-2'>
                      <div className='grid grid-cols-5 gap-4'>
                        ...
                        <div className='flex flex-col justify-between col-span-2'>
                          ...
                          <div className='flex gap-4'>
                            ...
                            <Button disabled onClick={showModal} className='!h-10 !w-[130px] !rounded-3xl !border-[#79747E]'>
                      ...
                      <div className='flex gap-4 mt-5'>
                        <div className='flex flex-col justify-between'>
                          <p className='text-[#49454F] mb-5'>Packaging:</p>
                          <div className='flex gap-4'>
                            <p className='text-[22px] font-[400px]'>Not Started</p>
                            <Button disabled className='!h-10 !w-[115px] !rounded-3xl !border-[#79747E] !text-[#6750A4]'>
                              <div className='flex items-center text-center gap-2'>
                                <IconChange />
          ...
          <div className='flex gap-4 mt-8'>
            <Link href="/orders">
              <Button className='!rounded-3xl !px-5 !text-center border-[#79747E] !h-10'>
                <div className='flex items-center gap-2'>
                  <IconBack />
