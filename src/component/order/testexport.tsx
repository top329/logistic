...
export default function Export() {
  ...
  function PgDetailCollapseChild () {   
    return(
      <div
      ...
      >
        ...
        <div>
          <Input 
            className='!flex !items-start !text-base h-[144px] !w-full !border !rounded-[20px] border-[#79747E]'
  ...
  const Package_Details = () => {
      return(
          ...
          >
              ...
              >
                <div className='mt-[-9px] mx-3 px-2 selectText !text-[#6750A4] !bg-white z-10'>Origin/Shipment Location</div>
                <Select
